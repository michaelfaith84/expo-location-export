...
class KML {
  private _buildKML(data: Props, global: GlobalParams) {
    const kml: any = {
      "attr-xmlns": kmlNS,
    };
  ...
  toPoint(data: Data[], global: GlobalParams, options: KMLExportOptions) {
    ...
    return this._buildKML(points, global);
  }

  /**
   * LineString
   * Keys: name, description, LineString
   */
  toLineString(data: Data[], global: GlobalParams, options: KMLExportOptions) {
    ...
    return this._buildKML(linestring, global);
  }
}
